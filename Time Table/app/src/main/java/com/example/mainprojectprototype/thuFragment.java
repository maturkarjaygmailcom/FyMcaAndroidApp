...
//        dslab=view.findViewById(R.id.dslab);
        ...
        TextView bdtlabone,bdtlabtwo,breakone,ds,py,breaktwo,andrlabone,andrlabtwo;
        bdtlabone=view.findViewById(R.id.bdtlabone);
        bdtlabtwo=view.findViewById(R.id.bdtlabtwo);
        ...
        if (day == 5){
            ...
            if (hour == 9 && minute >= 0 && minute < 60) {
                //bdtlabone
                bdtlabone.setBackgroundColor(Color.parseColor("#8BBEE8FF"));
            }
            else if (hour == 10 && minute >= 0 && minute < 60) {
                //bdtlabtwo
                bdtlabtwo.setBackgroundColor(Color.parseColor("#8BBEE8FF"));
            }
